...
def main():
    ...
    with vision.HandLandmarker.create_from_options(options) as landmarker:
        ...
        while True:
            ...
            if (latest_result is not None and latest_timestamp != last_processed_timestamp):
                ...
                if latest_result.hand_landmarks:
                    ...
                    if len(point_history) == history_length:
                        ...
                        motion_text = point_history_classifier_labels[finger_gesture_id]
            ...
            debug_image = draw_info(debug_image, fps, hand_sign_text, motion_text)
...
def draw_info(image, fps, hand_sign_text, motion_text):
    
    cv.putText(image, f"FPS:{fps}", (10, 30), cv.FONT_HERSHEY_SIMPLEX, 1.0, (255,255,255), 2)
    cv.putText(image, f"Hand:{hand_sign_text}", (10,70), cv.FONT_HERSHEY_SIMPLEX, 1.0, (0,255,0), 2 )
    cv.putText(image, f"Finger Gesture:{motion_text}", (10,110), cv.FONT_HERSHEY_SIMPLEX, 1.0, (0,255,255), 2)
